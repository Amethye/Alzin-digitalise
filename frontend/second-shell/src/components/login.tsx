    ...
    <div className="w-full max-w-md rounded-xl bg-white px-5 py-6 shadow-lg sm:px-8">
      ...
      <form onSubmit={handleSubmit} className="stack" noValidate>
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="rounded-lg border-2 border-bleu bg-bleu px-4 py-2 text-white transition duration-150 hover:bg-blue-50 hover:text-bleu disabled:opacity-60 disabled:cursor-not-allowed"
        >
